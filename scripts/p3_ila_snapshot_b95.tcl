# p3_ila_snapshot_b95.tcl -- Snapshot all ILAs at stall with Build 95.
set hw_server_url "100.93.77.36"
set hw_server_port "3121"
set xvc_host "202.197.4.99"
set xvc_port "2540"
set default_ltx {D:/p3b95_l2_axi/p3_top_build95_l2_axi.ltx}
set default_output_dir {D:/p3b95_l2_axi/l2_snapshot}
...
foreach ila $armed {
    ...
    set csv "${output_dir}/ila_snapshot_b95_${ts}_${safe}.csv"
    write_hw_ila_data -force -csv_file $csv $data
    if {![file exists $csv] || [file size $csv] == 0} { error "CSV missing: $csv" }
    puts "Build 95 CSV: $csv"
}
close_hw_target
disconnect_hw_server
close_hw_manager
puts "SUCCESS: Build 95 snapshot complete"
