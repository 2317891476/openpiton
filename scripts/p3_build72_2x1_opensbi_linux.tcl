...
#   vivado -mode batch -source scripts/p3_build68_8x8_opensbi_linux.tcl -tclargs -skip_create -skip_prepare -reuse_synth -jobs 32
...
set env(P3_BUILD52_PROJECT_NAME) "huaprop3_build72_2x1_opensbi_linux"
if {[info exists env(P3_BUILD72_WORK_DIR)] && $env(P3_BUILD72_WORK_DIR) ne ""} {
    set env(P3_BUILD52_WORK_DIR) $env(P3_BUILD72_WORK_DIR)
} else {
    set env(P3_BUILD52_WORK_DIR) [file normalize "${repo_dir}/p3b72_2x1"]
}
set env(P3_BUILD52_PDI_BASENAME) "p3_top_build72_2x1_opensbi_linux"
set env(P3_BUILD52_EXTRA_DEFINES) "P3_SPI_SD_BOOT P3_SPI_SD_BLOCK_DEBUG"
set env(P3_BUILD52_BOOTROM_REBUILD_SH) [file normalize "${script_dir}/p3_rebuild_build72_2x1_opensbi_linux.sh"]
