# p3_ila_capture_build48_boot_progress.tcl -- Capture Build 48 boot-progress ILAs.

set hw_server_url "100.93.77.36"
set hw_server_port "3121"
set xvc_host "202.197.4.99"
set xvc_port "2540"
set project_dir [file normalize "[file dirname [info script]]/../huaprop3_build48_boot_progress"]
set ltx_file "${project_dir}/debug_build/p3_top_build48_boot_progress.ltx"
...
puts "=========================================="
puts " P3 Build 48 AXI16550 Boot-Progress ILA Capture"
...
foreach ila $ilas {
    ...
    set csv_file "${output_dir}/ila_capture_build48_${idx}_${clean_name}.csv"
...
puts "=========================================="
puts " Build 48 AXI16550 boot-progress debug ILA capture complete"
puts "=========================================="
