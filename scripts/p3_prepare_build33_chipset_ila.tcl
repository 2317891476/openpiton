# p3_prepare_build33_chipset_ila.tcl -- Patch the P3 BD for chipset-path ILAs.
# Usage:
#   vivado -mode batch -source scripts/p3_prepare_build33_chipset_ila.tcl
#
# Build 33 keeps the Build 32 compact chipset probe payload, but refreshes the
# Z:/tmp RTL mirrors before regenerating Vivado run scripts. Build 32 proved
# that stale temp RTL can leave the BD wrapper debug inputs undriven.
...
set tmp_dir "Z:/tmp"
set p3_chipset_ila_build_label "Build 33"
...
# unconditionally. They are not connected to Build 33 ILAs.
...
# Remove stale wide/split debug ports so the wrapper reflects Build 33 only.
