# p3_ila_capture_build47_normal_boot.tcl -- Capture Build 47 ILAs.

set hw_server_url "100.93.77.36"
set hw_server_port "3121"
set xvc_host "202.197.4.99"
set xvc_port "2540"
set project_dir [file normalize "[file dirname [info script]]/../huaprop3_build47_normal_boot_translated_ddr"]
set ltx_file "${project_dir}/debug_build/p3_top_build47_normal_boot_translated_ddr.ltx"
...
puts "=========================================="
puts " P3 Build 47 Normal AXI16550 Boot ILA Capture"
...
foreach ila $ilas {
    ...
    set csv_file "${output_dir}/ila_capture_build47_${idx}_${clean_name}.csv"
...
puts "=========================================="
puts " Build 47 normal AXI16550 boot ILA capture complete"
puts "=========================================="
