# p3_ila_capture_build45_axi_phys_ddr.tcl -- Capture Build 45 ILAs.

set hw_server_url "100.93.77.36"
set hw_server_port "3121"
set xvc_host "202.197.4.99"
set xvc_port "2540"
set project_dir [file normalize "[file dirname [info script]]/../huaprop3_build45_axi_phys_ddr"]
set ltx_file "${project_dir}/debug_build/p3_top_build45_axi_phys_ddr.ltx"
...
puts "=========================================="
puts " P3 Build 45 AXI16550 DDR Probe ILA Capture"
...
foreach ila $ilas {
    ...
    set csv_file "${output_dir}/ila_capture_build45_${idx}_${clean_name}.csv"
...
puts "=========================================="
puts " Build 45 AXI16550 DDR probe ILA capture complete"
puts "=========================================="
