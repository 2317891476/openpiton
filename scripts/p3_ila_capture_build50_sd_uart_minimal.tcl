# p3_ila_capture_build50_sd_uart_minimal.tcl -- Capture Build 50 SD-UART minimal ILAs.

set hw_server_url "100.93.77.36"
set hw_server_port "3121"
set xvc_host "202.197.4.99"
set xvc_port "2540"
set project_dir [file normalize "[file dirname [info script]]/../huaprop3_build50_sd_uart_minimal"]
set ltx_file "${project_dir}/debug_build/p3_top_build50_sd_uart_minimal.ltx"
...
puts "=========================================="
puts " P3 Build 50 no-stack AXI16550 SD-UART ILA Capture"
...
foreach ila $ilas {
    ...
    set csv_file "${output_dir}/ila_capture_build50_${idx}_${clean_name}.csv"
...
puts "=========================================="
puts " Build 50 AXI16550 SD-UART minimal debug ILA capture complete"
puts "=========================================="
