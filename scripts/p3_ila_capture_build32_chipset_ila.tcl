# p3_ila_capture_build32_chipset_ila.tcl -- Capture Build 32 chipset ILAs.
# Usage: vivado -mode batch -source scripts/p3_ila_capture_build32_chipset_ila.tcl
...
set ltx_file "${project_dir}/debug_build/p3_top_build32_runmgr_chipset_ila.ltx"
...
puts "=========================================="
puts " P3 Build 32 Chipset ILA Capture"
...
foreach ila $ilas {
    ...
    set csv_file "${output_dir}/ila_capture_build32_${idx}_${clean_name}.csv"
...
puts "=========================================="
puts " Build 32 chipset ILA capture complete"
puts "=========================================="
