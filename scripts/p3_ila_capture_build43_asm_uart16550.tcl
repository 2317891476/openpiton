# p3_ila_capture_build43_asm_uart16550.tcl -- Capture Build 43 ILAs.

set hw_server_url "100.93.77.36"
set hw_server_port "3121"
set xvc_host "202.197.4.99"
set xvc_port "2540"
set project_dir [file normalize "[file dirname [info script]]/../huaprop3_build43_asm_uart16550"]
set ltx_file "${project_dir}/debug_build/p3_top_build43_asm_uart16550.ltx"
...
puts "=========================================="
puts " P3 Build 43 AXI16550 ASM UART ILA Capture"
...
foreach ila $ilas {
    ...
    set csv_file "${output_dir}/ila_capture_build43_${idx}_${clean_name}.csv"
...
puts "=========================================="
puts " Build 43 AXI16550 ASM UART ILA capture complete"
puts "=========================================="
