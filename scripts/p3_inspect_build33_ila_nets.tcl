# p3_inspect_build33_ila_nets.tcl -- Inspect Build 33 routed ILA probe nets.
#
# Usage:
#   vivado -mode batch -source scripts/p3_inspect_build33_ila_nets.tcl

set script_dir [file dirname [info script]]
set repo_dir [file normalize "${script_dir}/.."]
set run_dir [file normalize "${repo_dir}/huaprop3_openpiton/huaprop3_openpiton.runs/impl_33_chipila"]
set routed_dcp "${run_dir}/p3_top_routed.dcp"
set out_file [file normalize "${repo_dir}/huaprop3_openpiton/debug_build/build33_ila_net_inspect.txt"]
...
p3_puts $fh "Build 33 routed ILA net inspection"
