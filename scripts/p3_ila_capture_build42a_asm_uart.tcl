# p3_ila_capture_build42a_asm_uart.tcl -- Capture Build 42-A UART ILAs.

set hw_server_url "100.93.77.36"
set hw_server_port "3121"
set xvc_host "202.197.4.99"
set xvc_port "2540"
set project_dir [file normalize "[file dirname [info script]]/../huaprop3_build42a_asm_uart"]
set ltx_file "${project_dir}/debug_build/p3_top_build42a_asm_uart.ltx"
...
puts "=========================================="
puts " P3 Build 42-A ASM UART ILA Capture"
...
puts "ILAs: $ilas"
if {[llength $ilas] != 2} {
    puts "ERROR: expected 2 ILA cores, found [llength $ilas]"
    exit 1
}
...
foreach ila $ilas {
    ...
    set csv_file "${output_dir}/ila_capture_build42a_${idx}_${clean_name}.csv"
...
puts "=========================================="
puts " Build 42-A ASM UART ILA capture complete"
puts "=========================================="
