# p3_ila_capture_build31_split_ila.tcl -- Capture Build 31 split BD ILAs.
# Usage: vivado -mode batch -source scripts/p3_ila_capture_build31_split_ila.tcl
...
set ltx_file "${project_dir}/debug_build/p3_top_build31_runmgr_split_ila.ltx"
...
puts "=========================================="
puts " P3 Build 31 Split ILA Capture"
...
foreach ila $ilas {
    ...
    set csv_file "${output_dir}/ila_capture_build31_${idx}_${clean_name}.csv"
...
puts "=========================================="
puts " Build 31 split ILA capture complete"
puts "=========================================="
