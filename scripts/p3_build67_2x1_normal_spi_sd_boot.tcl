...
#
# Keep the Vivado work project on a short Windows-local path. Creating Versal
# BD/IP output inside the WSL repo path can silently stop during early IP setup.
...
if {[info exists env(P3_BUILD67_WORK_DIR)] && $env(P3_BUILD67_WORK_DIR) ne ""} {
    ...
    set env(P3_BUILD52_WORK_DIR) [file normalize "D:/p3b67_2x1"]
}
