#!/usr/bin/env python3
"""Decode Build 44 no-stack DDR-probe ILA CSV captures."""
...
def main():
    ...
    parser.add_argument("debug_build_dir", help="Build 44 debug_build directory")
    args = parser.parse_args()
    try:
        axis0 = find_one(args.debug_build_dir, "ila_capture_build44_*axis_ila_0.csv")
        axis1 = find_one(args.debug_build_dir, "ila_capture_build44_*axis_ila_1.csv")
    ...
    print("PASS: Build 44 ILA observed DDR write/read AXI handshakes with OKAY responses")
    return 0
