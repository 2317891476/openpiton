# p3_ila_capture_build51_sd_init_debug.tcl -- Capture Build 51 SD init debug ILAs.

set hw_server_url "100.93.77.36"
set hw_server_port "3121"
set xvc_host "202.197.4.99"
set xvc_port "2540"
set project_dir [file normalize "[file dirname [info script]]/../huaprop3_build51_sd_init_debug"]
set ltx_file "${project_dir}/debug_build/p3_top_build51_sd_init_debug.ltx"
...
puts "=========================================="
puts " P3 Build 51 no-stack AXI16550 SD-init ILA Capture"
...
foreach ila $ilas {
    ...
    set csv_file "${output_dir}/ila_capture_build51_${idx}_${clean_name}.csv"
...
puts "=========================================="
puts " Build 51 AXI16550 SD init debug ILA capture complete"
puts "=========================================="
