...
> 2026-07-02 证据审计说明：本周报记录的是 6月2日 到 6月8日 的早期判断。
> Build 67 后续已经证明 Linux 可以越过 BBL `mret` 并打印更多启动日志，
> 因此文中的“停在 BBL 到 Linux earlycon 前”只能作为当时停点，不是当前多核
> 结论。当前 64 核方向应以最新 wiki 状态和板上分层证据链为准。
