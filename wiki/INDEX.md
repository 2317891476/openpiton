...
| Current scaling candidate | Build 68 8x8 / 64-core OpenSBI/Linux completed VP1902 synthesis, place, route, timing, PDI/LTX generation, P3 Pro programming, debug-hub refresh, and bundle-bootrom UART. It currently stops at the SD bundle copy because the final offline-rebuilt OpenSBI/Linux SD image is not on the card. |
