...
| Current scaling candidate | Build 68 8x8 / 64-core OpenSBI/Linux completed VP1902 implementation, PDI/LTX generation, P3 Pro programming, debug-hub refresh, and bundle-bootrom UART. The final source-rebuilt Linux 6.6/OpenSBI/64-hart SD image is generated and structurally verified; SD write and board boot remain pending. |
