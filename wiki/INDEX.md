...
| Single-core status | P3 Build 66 legacy BBL/Linux shell, SD ext2, and XSBench launch are verified. The unchanged-PDI OpenSBI v1.8/Linux 6.6 flat image has passed full 256 MiB SD readback; FPGA boot is pending. |
