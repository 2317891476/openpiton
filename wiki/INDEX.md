...
| Current scaling candidate | Build 68 8x8 / 64-core OpenSBI/Linux completed VP1902 synthesis, place, route, timing, and PDI/LTX generation; board programming and Linux boot remain pending. Build 67 remains the latest programmed multicore hardware result and exposes the unresolved 2-hart SMP forward-progress risk. |
