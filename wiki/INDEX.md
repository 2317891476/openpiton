...
| Current scaling candidate | Build 68 8x8 / 64-core OpenSBI/Linux completed `route_design` on VP1902 with timing met; PDI/LTX generation and board boot remain pending. Build 67 remains the latest programmed multicore hardware result and exposes the unresolved 2-hart SMP forward-progress risk. |
