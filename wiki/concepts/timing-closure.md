...
- Build 34 follows that rule by reusing the 97-bit structure and swapping in UART-local payload content, rather than adding another ILA or widening the probes.
