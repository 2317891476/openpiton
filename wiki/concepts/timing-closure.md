...
- Build 35 preserves the Build 34 97-bit debug width and only changes payload semantics to sticky UART last-write capture, so routing risk should remain comparable while avoiding another wide-probe expansion.
