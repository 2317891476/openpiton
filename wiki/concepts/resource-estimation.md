...
|------|----------|-------|----------|-----------|------------|------|-----|-------|
| 2026-06-13 | P3 / VP1902 | Build 69 8x8 OpenSBI diagnostic `synth_design` | 4,820,410 raw LUT primitives | 2,549,221 FD-style cells | 4,805 RAMB36 + 64 RAMB18 | 128 | 1,153 | Remote offline-Ubuntu Vivado 2024.2.2 `synth_design` passed with 0 errors and 0 critical warnings. The report listed design size 8,009,722 and 37,740 warnings. This row records the raw synthesis cell-usage report before the full Vivado run closed; `impl_1`, route, PDI/LTX generation, and board validation are still pending. Do not compare the raw LUT primitive count directly against post-place CLB LUT utilization rows. |
