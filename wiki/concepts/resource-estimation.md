...
|------|----------|-------|----------|-----------|------------|------|-----|-------|
| 2026-06-12 | P3 / VP1902 | Build 68 8x8 OpenSBI/Linux setup | 4,424,744 | 2,553,630 | 4,836 | 128 | 1,153 | Remote offline-Ubuntu Vivado 2024.2.2 run completed main 64-core `synth_1` at 04:29 CST and started `impl_1`. The synthesized 8x8 top used 52.30% CLB LUTs, 15.09% registers, 71.03% BRAM tiles, 5.82% URAM, and 16.80% DSP slices on `xcvp1902-vsva6865-1MP-e-S`. This clears the previous source/elaboration gates (`p3_ariane_debug_bus` and missing `bootrom`) but does not yet prove placement, routing, congestion, timing, PDI generation, or board boot. BRAM pressure is now the first quantified capacity risk. |
