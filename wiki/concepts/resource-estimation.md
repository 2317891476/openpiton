...
|------|----------|-------|----------|-----------|------------|------|-----|-------|
| 2026-06-11 | P3 / VP1902 | Build 68 8x8 OpenSBI/Linux setup | TBD | TBD | TBD | TBD | TBD | 64-core target wrapper and OpenSBI bundle bootrom flow are created, but Vivado synthesis/place/route has not been run yet. Remote setup now reaches BD output generation and `synth_1` script creation, then stops at OOC ILA synthesis because the offline Ubuntu Vivado environment cannot check out `Synthesis`/`xcvp1902` license features. BRAM and routing remain unevaluated. |
