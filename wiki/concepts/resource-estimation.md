...
|------|----------|-------|----------|-----------|------------|------|-----|-------|
| 2026-06-11 | P3 / VP1902 | Build 68 8x8 OpenSBI/Linux setup | TBD | TBD | TBD | TBD | TBD | 64-core target wrapper and OpenSBI bundle bootrom flow are created, but Vivado synthesis/place/route has not been run yet. BRAM and routing remain the primary implementation risks; the first remote run must capture utilization, hierarchical utilization, congestion, SLR distribution, and timing before any board-boot claim. |
