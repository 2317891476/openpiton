...
|------|----------|-------|----------|-----------|------------|------|-----|-------|
| 2026-06-13 | P3 / VP1902 | Build 71 8x8 UART/SD source-closure diagnostic synthesis | 4,422,445 synth | 2,551,819 synth | 4,838 synth | 128 | 1,152 | Main `synth_design` completed with 0 errors and 0 critical warnings after 1:49:52 elapsed and about 42.3 GiB peak memory. `p3_top_utilization_synth.rpt` reports 52.27% CLB LUTs, 15.08% registers, 71.06% block RAM tiles, 5.82% URAM, and 16.78% DSP. Netlist translation also warns that `WEBWE[8]` is dropped when cache `RAMB36E5` instances are replaced by `RAMB36E5_INT`, which is a functional RAM-mapping risk pending implementation and board validation. |
