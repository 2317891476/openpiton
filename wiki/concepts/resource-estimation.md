...
|------|----------|-------|----------|-----------|------------|------|-----|-------|
| 2026-06-13 | P3 / VP1902 | Build 71 8x8 UART/SD source-closure diagnostic | 4,422,445 synth / 4,392,332 placed | 2,551,819 synth / 2,555,533 placed | 4,838 synth / 4,846 placed | 128 | 1,152 | Main synthesis, placement, routing, and formal timing completed with 0 errors. Placed utilization is 51.92% CLB LUTs, 15.10% registers, 71.18% block RAM tiles, 5.82% URAM, and 16.78% DSP. Vector-less power is a low-confidence 59.859 W estimate: 10.322 W dynamic and 49.537 W static under the default 100 C junction assumption, with inaccurate high-fanout reset activity flagged. Netlist translation also warns that `WEBWE[8]` is dropped when cache `RAMB36E5` instances are replaced by `RAMB36E5_INT`, which remains a functional board-validation risk. |
